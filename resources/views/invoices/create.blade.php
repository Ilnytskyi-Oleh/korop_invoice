            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <input type="button" id="add_row" class="btn btn-primary float-end" value="Add Row" />
                                <input type="button" id='delete_row' class="float-start btn btn-info" value="Delete Row" />
                            </div>
                        </div>
                        <div class="row clearfix" style="margin-top:20px">
                            <div class="col-md-12">
